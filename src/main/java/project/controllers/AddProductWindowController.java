...
public class AddProductWindowController {
    ...
    private void setLanguageInterface() {
        ...
        nameField.setPromptText(isEng? "Product name" : "Название продукта");
        categoryField.setPromptText(isEng? "Product category" : "Категория продукта");
        numberField.setPromptText(isEng? "Number of products" : "Количество продукта");
    }
